...
const PaginationControls: React.FC<PaginationControlsProps> = ({
  ...
  return (
    <div className="flex-shrink-0 mt-[20px] lg:mt-[25px] xl:mt-[30px] w-full">
      {/* Full-width divider that breaks out of CardContent padding but stays within Card bounds */}
      <div className="relative -mx-3 lg:-mx-4 mb-[15px] lg:mb-[20px] xl:mb-[25px]">
          ...
          <div className="flex items-center gap-[4px] xs:gap-[6px] sm:gap-[8px] lg:gap-[10px] xl:gap-[12px] flex-shrink-0 min-w-fit px-2 sm:px-0">
            ...
            >
              <svg 
                ...
                className="w-[10px] h-[10px] xs:w-[12px] xs:h-[12px] lg:w-[14px] lg:h-[14px] xl:w-[16px] xl:h-[16px] text-gray-200"
              >
                <path 
                  d="M10 12L6 8L10 4" 
                  stroke="currentColor" 
