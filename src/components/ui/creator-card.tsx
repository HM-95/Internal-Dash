...
import { Creator } from '../../../app/types/database';
import { formatNumber, getSocialMediaIcon, getMatchScoreColor, getMatchScoreStyle } from '../../../app/utils/formatters';
          ...
          {creator.niches
            ...
            .map((niche, index) => (
              <Badge
                key={index}
                variant="outline"
                className={`px-[6px] lg:px-[8px] xl:px-[10px] py-[2px] lg:py-[3px] xl:py-[4px] rounded-[6px] lg:rounded-[7px] xl:rounded-[8px] flex-shrink-0 bg-green-50 border-green-200 text-green-700 dark:bg-green-900/20 dark:border-green-700 dark:text-green-400`}
              >
